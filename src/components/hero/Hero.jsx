...
const Hero = () => {
  return (
    <div className=" w-full hero-section bg-gray-900 text-white bg-[url('/src/assets/HeroBanner.jpg')] bg-cover bg-no-repeat">
      {/* Banner Image or Video */}
      <div className="hero-banner py-[100px] ps-[50px] pe-4 z-10 w-full">
